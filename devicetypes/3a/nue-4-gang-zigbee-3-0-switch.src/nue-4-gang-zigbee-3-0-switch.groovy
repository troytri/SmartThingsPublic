...
metadata {
definition (name: "Nue 4 Gang ZigBee 3.0 Switch", namespace: "3A", author: "Kevin") {
    capability "Actuator"
 ...
 //   fingerprint profileId: "C05E", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "3A Smart Home DE", model: "LXN-4S27LX1.0", deviceJoinName: "Nue 4 Gang Switch"
}
...
log.debug "onoff"
def refreshCmds = zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 04]) +
zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 02]) +
zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 03]) +
zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 01])
...
[
    "st rattr 0x${device.deviceNetworkId} 0x01 0x0006 0x0000", "delay 10",
    "st rattr 0x${device.deviceNetworkId} 0x02 0x0006 0x0000", "delay 10",
    "st rattr 0x${device.deviceNetworkId} 0x03 0x0006 0x0000", "delay 10",
    "st rattr 0x${device.deviceNetworkId} 0x04 0x0006 0x0000", "delay 10",
]
}
